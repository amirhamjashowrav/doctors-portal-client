...
const AppointmentForm = ({ modalIsOpen, closeModal, appointmentOn, date }) => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://tranquil-basin-09507.herokuapp.com/addAppointment', {
            method: 'POST',
                ...
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group row">
                        <div className="col-4">
                            ...
                            <select className="form-select" aria-label="Default select example" name="gender" ref={register({ required: true })} >
